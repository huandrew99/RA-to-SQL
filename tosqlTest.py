...
def unifyTimes(oldString):
    ...
    newString = ""
    if substring in oldString:
        newString = oldString.replace("\times", "\j")
        return newString
    else:
        return oldString
...
def unifyNaturaljoin(oldString):
    ...
    newString = ""
    if substring in oldString:
        newString = oldString.replace("\bowtie", "\\natural_join")
        return newString
    else:
        return oldString
...
# """
    ...
    #Q4.1
    # str = """
    # BAB \leftarrow Book \j_{Book.BookId = AuthorBook.BookId } AuthorBook;
    # """
